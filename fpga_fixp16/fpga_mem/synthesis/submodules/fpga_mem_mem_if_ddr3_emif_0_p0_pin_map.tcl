...
proc fpga_mem_mem_if_ddr3_emif_0_p0_get_ddr_pins { instname allpins } {
	...
	# AFI PHY CLOCK PLL
	set pll_afi_phy_clock_id [fpga_mem_mem_if_ddr3_emif_0_p0_get_output_clock_id $pins(afi_phy_ck_pins) "AFI PHY CK" msg_list]
	if {$pll_afi_phy_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "fpga_mem_mem_if_ddr3_emif_0_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "fpga_mem_mem_if_ddr3_emif_0_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(afi_phy_ck_pins)]"
	} else {
		set pll_afi_phy_clock [fpga_mem_mem_if_ddr3_emif_0_p0_get_pll_clock_name $pll_afi_phy_clock_id]
	}
	...
	# AC PLL
	set pll_ac_clock_id [fpga_mem_mem_if_ddr3_emif_0_p0_get_output_clock_id $pins(add_pins) "Address/Command Output" msg_list]
	if {$pll_ac_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "fpga_mem_mem_if_ddr3_emif_0_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "fpga_mem_mem_if_ddr3_emif_0_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(add_pins)]"
	} else {
		set pll_ac_clock [fpga_mem_mem_if_ddr3_emif_0_p0_get_pll_clock_name $pll_ac_clock_id]
	}
...
proc fpga_mem_mem_if_ddr3_emif_0_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		fpga_mem_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins pll_afi_phy_clock
		...
		fpga_mem_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins pll_ac_clock
