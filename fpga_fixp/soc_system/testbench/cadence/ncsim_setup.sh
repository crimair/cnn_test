...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_rsp_xbar_mux.sv"            -work rsp_xbar_mux                                                                -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                               
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_rsp_xbar_demux.sv"          -work rsp_xbar_demux                                                              -cdslib ./cds_libs/rsp_xbar_demux.cds.lib                                                             
  ...
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_cmd_xbar_mux.sv"            -work cmd_xbar_mux                                                                -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                               
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_cmd_xbar_demux.sv"          -work cmd_xbar_demux                                                              -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                             
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_id_router.sv"               -work id_router                                                                   -cdslib ./cds_libs/id_router.cds.lib                                                                  
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2_addr_router.sv"             -work addr_router                                                                 -cdslib ./cds_libs/addr_router.cds.lib                                                                
  ncvlog -sv "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                             -work rsp_xbar_mux                                                                -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                               
  ...
  ncvlog     "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/soc_system_mm_interconnect_2.v"                          -work mm_interconnect_2                                                           -cdslib ./cds_libs/mm_interconnect_2.cds.lib                                                          
  ...
  ncvlog     "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/altera_avalon_mm_clock_crossing_bridge.v"                -work mm_clock_crossing_bridge_0                                                  -cdslib ./cds_libs/mm_clock_crossing_bridge_0.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/altera_avalon_dc_fifo.v"                                 -work mm_clock_crossing_bridge_0                                                  -cdslib ./cds_libs/mm_clock_crossing_bridge_0.cds.lib                                                 
  ncvlog     "$QSYS_SIMDIR/soc_system_tb/simulation/submodules/altera_dcfifo_synchronizer_bundle.v"                     -work mm_clock_crossing_bridge_0                                                  -cdslib ./cds_libs/mm_clock_crossing_bridge_0.cds.lib                                                 
