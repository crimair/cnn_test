...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_xbar_mux.sv"            -L altera_common_sv_packages -work rsp_xbar_mux                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_xbar_demux.sv"          -L altera_common_sv_packages -work rsp_xbar_demux                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -L altera_common_sv_packages -work cmd_xbar_mux                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_xbar_mux.sv"            -L altera_common_sv_packages -work cmd_xbar_mux                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_xbar_demux.sv"          -L altera_common_sv_packages -work cmd_xbar_demux                                                             
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_id_router.sv"               -L altera_common_sv_packages -work id_router                                                                  
  vlog -sv "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_addr_router.sv"             -L altera_common_sv_packages -work addr_router                                                                
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -L altera_common_sv_packages -work rsp_xbar_mux                                                               
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L border -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L id_router -L addr_router -L burst_adapter -L limiter -L sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -L sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent -L hps_0_h2f_lw_axi_master_agent -L sysid_qsys_control_slave_translator -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_0 -L mm_clock_crossing_bridge_0 -L mm_bridge_0 -L sysid_qsys -L hps_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L border -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L id_router -L addr_router -L burst_adapter -L limiter -L sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent_rsp_fifo -L sysid_qsys_control_slave_translator_avalon_universal_slave_0_agent -L hps_0_h2f_lw_axi_master_agent -L sysid_qsys_control_slave_translator -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_0 -L mm_clock_crossing_bridge_0 -L mm_bridge_0 -L sysid_qsys -L hps_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
