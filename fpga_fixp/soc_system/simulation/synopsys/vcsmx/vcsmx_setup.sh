...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_xbar_mux.sv"            -work rsp_xbar_mux                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_rsp_xbar_demux.sv"          -work rsp_xbar_demux                                                             
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work cmd_xbar_mux                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_xbar_mux.sv"            -work cmd_xbar_mux                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_cmd_xbar_demux.sv"          -work cmd_xbar_demux                                                             
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_id_router.sv"               -work id_router                                                                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2_addr_router.sv"             -work addr_router                                                                
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                             -work rsp_xbar_mux                                                               
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_2.v"                          -work mm_interconnect_2                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/soc_system_mm_interconnect_0.v"                          -work mm_interconnect_0                                                          
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_avalon_mm_clock_crossing_bridge.v"                -work mm_clock_crossing_bridge_0                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_avalon_dc_fifo.v"                                 -work mm_clock_crossing_bridge_0                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_dcfifo_synchronizer_bundle.v"                     -work mm_clock_crossing_bridge_0                                                 
