...
lappend arg_list "--component-param=MEM_TINIT_CK=175000"
...
lappend arg_list "--component-param=SEQ_ROM=soc_system_mem_0_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=soc_system_mem_0_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=soc_system_mem_0_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=soc_system_mem_0_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:soc_system_mem_0_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:soc_system_mem_0_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/usr/tool/Altera/13.1s/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
