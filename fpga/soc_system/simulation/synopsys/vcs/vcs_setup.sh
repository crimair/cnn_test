...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_id_router.sv \
  $QSYS_SIMDIR/submodules/soc_system_mm_interconnect_1_addr_router.sv \
