...
proc fpga_mem_mem_if_ddr3_emif_0_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	foreach ac_pin $ac_pins {
		...
		set ac_clk_phase_select_node [fpga_mem_mem_if_ddr3_emif_0_p0_traverse_to_clkbuf $ac_pin msg_list]
		...
		set extra_ccpr [fpga_mem_mem_if_ddr3_emif_0_p0_round_3dp [expr ($clk_max - $clk_min + 0.5*($ac_max - $ac_min))/2.0]]
