...
/* //input data matrix
 ...
 (d20 , d21 , d22)
 */
input wire [31:0]  d00_in; //fix32_24
input wire [31:0]  d01_in; //fix32_24
input wire [31:0]  d02_in; //fix32_24
input wire [31:0]  d10_in; //fix32_24
input wire [31:0]  d11_in; //fix32_24
input wire [31:0]  d12_in; //fix32_24
input wire [31:0]  d20_in; //fix32_24
input wire [31:0]  d21_in; //fix32_24
input wire [31:0]  d22_in; //fix32_24
/* //weight parameter matrix
 (d00 , d01 , d02)
 (d10 , d11 , d12)
 (d20 , d21 , d22)
 */
input wire [31:0]  w00_in; //fix32_24
input wire [31:0]  w01_in; //fix32_24
input wire [31:0]  w02_in; //fix32_24
input wire [31:0]  w10_in; //fix32_24
input wire [31:0]  w11_in; //fix32_24
input wire [31:0]  w12_in; //fix32_24
input wire [31:0]  w20_in; //fix32_24
input wire [31:0]  w21_in; //fix32_24
input wire [31:0]  w22_in; //fix32_24

output wire        en_out;
output wire [31:0] d_out; //fix32_24
...
*/
fd_mult_32x32 fd_mult_00 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_01 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_02 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_10 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_11 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_12 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_20 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_21 (/*AUTOINST*/
                          // Outputs
...
fd_mult_32x32 fd_mult_22 (/*AUTOINST*/
                          // Outputs
...
*/
fd_add_32x32 fd_add_0001(/*AUTOINST*/
                         // Outputs
...
fd_add_32x32 fd_add_0210(/*AUTOINST*/
                         // Outputs
...
fd_add_32x32 fd_add_1112(/*AUTOINST*/
                         // Outputs
...
fd_add_32x32 fd_add_2021(/*AUTOINST*/
                         // Outputs
...
fd_add_32x32 fd_add_22XX(/*AUTOINST*/
                         // Outputs
...
*/
fd_add_32x32 fd_add_00010210(/*AUTOINST*/
                             // Outputs
...
fd_add_32x32 fd_add_11122021(/*AUTOINST*/
                             // Outputs
...
fd_add_32x32 fd_add_22XXXXXX(/*AUTOINST*/
                             // Outputs
...
*/
fd_add_32x32 fd_add_0001021011122021(/*AUTOINST*/
                                     // Outputs
...
fd_add_32x32 fd_add_22XXXXXXXXXXXXXX(/*AUTOINST*/
                                     // Outputs
...
fd_add_32x32 fd_add_000102101112202122XXXXXXXXXXXXXX(/*AUTOINST*/
                                                     // Outputs
