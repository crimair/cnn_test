...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=13 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab result
//VERSION_BEGIN 13.1 cbx_altbarrel_shift 2014:03:12:18:15:27:SJ cbx_altfp_add_sub 2014:03:12:18:15:27:SJ cbx_altpriority_encoder 2014:03:12:18:15:29:SJ cbx_cycloneii 2014:03:12:18:15:29:SJ cbx_lpm_add_sub 2014:03:12:18:15:29:SJ cbx_lpm_compare 2014:03:12:18:15:29:SJ cbx_mgl 2014:03:12:21:10:00:SJ cbx_stratix 2014:03:12:18:15:31:SJ cbx_stratixii 2014:03:12:18:15:31:SJ  VERSION_END
...
//VERSION_BEGIN 13.1 cbx_altbarrel_shift 2014:03:12:18:15:27:SJ cbx_mgl 2014:03:12:21:10:00:SJ  VERSION_END

//synthesis_resources = reg 27 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altbarrel_shift_t8e
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_32x32_altbarrel_shift_t8e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altbarrel_shift_3cg
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_add_32x32_altbarrel_shift_3cg


//altpriority_encoder CBX_AUTO_BLACKBOX="ALL" PIPELINE=1 WIDTH=32 WIDTHAD=5 aclr clk_en clock data q
//VERSION_BEGIN 13.1 cbx_altpriority_encoder 2014:03:12:18:15:29:SJ cbx_mgl 2014:03:12:21:10:00:SJ  VERSION_END
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fp_add_32x32_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fp_add_32x32_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //fp_add_32x32_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fp_add_32x32_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //fp_add_32x32_altpriority_encoder_be8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //fp_add_32x32_altpriority_encoder_3v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_add_32x32_altpriority_encoder_3v7   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	fp_add_32x32_altpriority_encoder_3e8   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //fp_add_32x32_altpriority_encoder_6v7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_add_32x32_altpriority_encoder_6v7   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	fp_add_32x32_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //fp_add_32x32_altpriority_encoder_bv7

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_uv8
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_add_32x32_altpriority_encoder_be8   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fp_add_32x32_altpriority_encoder_bv7   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //fp_add_32x32_altpriority_encoder_uv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_ue9
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	fp_add_32x32_altpriority_encoder_be8   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //fp_add_32x32_altpriority_encoder_ue9

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_ou8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_add_32x32_altpriority_encoder_uv8   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fp_add_32x32_altpriority_encoder_ue9   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fp_add_32x32_altpriority_encoder_ou8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //fp_add_32x32_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_nh8   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	fp_add_32x32_altpriority_encoder_nh8   altpriority_encoder28
	( 
	.data(data[3:2]),
...
endmodule //fp_add_32x32_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_qh8   altpriority_encoder25
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	fp_add_32x32_altpriority_encoder_qh8   altpriority_encoder26
	( 
	.data(data[7:4]),
...
endmodule //fp_add_32x32_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_ii9
	( 
	data,
	q,
	zero) ;
	...
	fp_add_32x32_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fp_add_32x32_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //fp_add_32x32_altpriority_encoder_ii9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //fp_add_32x32_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	fp_add_32x32_altpriority_encoder_nh8   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	fp_add_32x32_altpriority_encoder_n28   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //fp_add_32x32_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	fp_add_32x32_altpriority_encoder_qh8   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	fp_add_32x32_altpriority_encoder_q28   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //fp_add_32x32_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_i39
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	fp_add_32x32_altpriority_encoder_vh8   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	fp_add_32x32_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //fp_add_32x32_altpriority_encoder_i39

//synthesis_resources = reg 5 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altpriority_encoder_cna
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_add_32x32_altpriority_encoder_ii9   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	fp_add_32x32_altpriority_encoder_i39   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //fp_add_32x32_altpriority_encoder_cna

//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 701 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_32x32_altfp_add_sub_caj
	( 
	clock,
	dataa,
	datab,
	...
	fp_add_32x32_altbarrel_shift_t8e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_32x32_altbarrel_shift_3cg   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_32x32_altpriority_encoder_ou8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_32x32_altpriority_encoder_cna   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_add_32x32_altfp_add_sub_caj
//VALID FILE
...
module fp_add_32x32 (
	...
	fp_add_32x32_altfp_add_sub_caj	fp_add_32x32_altfp_add_sub_caj_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.result (sub_wire0));
