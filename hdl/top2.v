...
fpga_mem u1(
            ...
            .mc1_waitrequest      (mr1_waitrequest   ),
            .mc1_readdata         (mr1_readdata      ),
            .mc1_readdatavalid    (mr1_readdatavalid ),
            .mc1_burstcount       ((mw1_write) ? mw1_burstcount[5:0] : mr1_burstcount[5:0]),
            .mc1_writedata        (mw1_writedata),
            .mc1_address          ((mw1_write) ? mw1_address : mr1_address),
            .mc1_write            (mw1_write),
            .mc1_read             (mr1_read),
            .mc1_byteenable       (16'hffff),
            .mc1_debugaccess      (1'b0),

            .mc2_waitrequest      (mr2_waitrequest   ),
            .mc2_readdata         (mr2_readdata      ),
            .mc2_readdatavalid    (mr2_readdatavalid ),
            .mc2_burstcount       ((mw2_write) ? mw2_burstcount[5:0] : mr2_burstcount[5:0]),
            .mc2_writedata        (mw2_writedata),
            .mc2_address          ((mw2_write) ? mw2_address : mr2_address),
            .mc2_write            (mw2_write),
            .mc2_read             (mr2_read),
            .mc2_byteenable       (16'hffff),
            .mc2_debugaccess      (1'b0),

            .mc3_waitrequest      (mr3_waitrequest   ),
            .mc3_readdata         (mr3_readdata      ),
            .mc3_readdatavalid    (mr3_readdatavalid ),
            .mc3_burstcount       ((mw3_write) ? mw3_burstcount[5:0] : mr3_burstcount[5:0]),
            .mc3_writedata        (mw3_writedata),
            .mc3_address          ((mw3_write) ? mw3_address : mr3_address),
            .mc3_write            (mw3_write),
            .mc3_read             (mr3_read),
            .mc3_byteenable       (16'hffff),
            .mc3_debugaccess      (1'b0),
...
(/*AUTOINST*/
 ...
 .mwx_waitrequest                       (mwx_waitrequest),
 .mw0_waitrequest                       (mw0_waitrequest),
 .mw1_waitrequest                       (mr1_waitrequest),
 .mw2_waitrequest                       (mr2_waitrequest),
 .mw3_waitrequest                       (mr3_waitrequest));
