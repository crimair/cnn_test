...
alias com {
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                            -work rsp_xbar_mux_010                                                         
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_rsp_xbar_mux_010.sv"                         -work rsp_xbar_mux_010                                                         
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_cmd_xbar_demux_010.sv"                       -work cmd_xbar_demux_010                                                       
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_addr_router_010.sv"                          -work addr_router_010                                                          
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                           -work mem_if_ddr3_emif_0_avl_translator_avalon_universal_slave_0_agent         
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                    -work mem_if_ddr3_emif_0_avl_translator_avalon_universal_slave_0_agent         
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                          -work mm_bridge_0_m0_translator_avalon_universal_master_0_agent                
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                      -work mem_if_ddr3_emif_0_avl_translator                                        
  vlog                                       "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                     -work mm_bridge_0_m0_translator                                                
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_cmd_xbar_mux_005.sv"   -work s0                                                                       
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_id_router_005.sv"      -work s0                                                                       
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_rsp_xbar_demux_005.sv" -work s0                                                                       
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_p0_memphy.sv"                               -work p0                                                                       
  ...
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_p0_read_datapath.sv"                        -work p0                                                                       
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_p0_write_datapath.v"                        -work p0                                                                       
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_p0_core_shadow_registers.sv"                -work p0                                                                       
  vlog                                       "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_p0_simple_ddio_out.sv"                      -work p0                                                                       
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L a0 -L ng0 -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L timing_adt -L jtag_phy_embedded_in_jtag_master -L crosser -L rsp_xbar_mux_010 -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_010 -L cmd_xbar_demux -L id_router -L addr_router_010 -L addr_router -L mem_if_ddr3_emif_0_avl_translator_avalon_universal_slave_0_agent_rsp_fifo -L mem_if_ddr3_emif_0_avl_translator_avalon_universal_slave_0_agent -L mm_bridge_0_m0_translator_avalon_universal_master_0_agent -L mem_if_ddr3_emif_0_avl_translator -L mm_bridge_0_m0_translator -L mm_interconnect_0 -L dll0 -L oct0 -L c0 -L dmaster -L s0 -L m0 -L p0 -L pll0 -L rst_controller -L mm_bridge_0 -L mem_if_ddr3_emif_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
