...
wire         mwa_write;
wire [25:0]  mwa_address;
wire [7:0]   mwa_burstcount; //16burst fix
wire         mwa_waitrequest;
wire [127:0] mwa_writedata;
...
assign fpga_reset_n = hps_fpga_reset_n & RESET_n & (~hps_reset_req[2]);
...
fpga_mem u1(
            ...
            .mwa_waitrequest      (mwa_waitrequest   ),
            .mwa_readdata         (),
            .mwa_readdatavalid    (),
            .mwa_burstcount       (mwa_burstcount    [5:0]),
            .mwa_writedata        (mwa_writedata     ),
            .mwa_address          (mwa_address       ),
            .mwa_write            (mwa_write         ),
            .mwa_read             (1'b0),
            .mwa_byteenable       (16'hffff),
            .mwa_debugaccess      (1'b0),
...
(/*AUTOINST*/
 ...
 .mwa_write                             (mwa_write),
 .mwa_address                           (mwa_address[25:0]),
 .mwa_burstcount                        (mwa_burstcount[7:0]),
 .mwa_writedata                         (mwa_writedata[127:0]),
 .zcnn_busy                             (zcnn_busy),
 // Inputs
