...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_rsp_xbar_mux_001.sv"                         -work rsp_xbar_mux_001                                                           
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_cmd_xbar_demux_001.sv"                       -work cmd_xbar_demux_001                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mm_interconnect_0_addr_router_001.sv"                          -work addr_router_001                                                            
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                           -work mem_if_ddr3_emif_0_avl_0_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                    -work mem_if_ddr3_emif_0_avl_0_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                          -work mm_bridge_10_m0_translator_avalon_universal_master_0_agent                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                      -work mem_if_ddr3_emif_0_avl_0_translator                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                     -work mm_bridge_10_m0_translator                                                 
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_mem_if_hard_memory_controller_top_cyclonev.sv"                   -work c0                                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_rsp_xbar_demux_001.sv" -work s0                                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altera_mem_if_simple_avalon_mm_bridge.sv"                               -work s0                                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_id_router_001.sv"      -work s0                                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/fpga_mem_mem_if_ddr3_emif_0_s0_mm_interconnect_0_cmd_xbar_mux_001.sv"   -work s0                                                                         
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/altdq_dqs2_acv_connect_to_hard_phy_cyclonev.sv"                         -work p0                                                                         
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L timing_adt -L jtag_phy_embedded_in_jtag_master -L crosser -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router -L addr_router_001 -L addr_router -L mem_if_ddr3_emif_0_avl_0_translator_avalon_universal_slave_0_agent_rsp_fifo -L mem_if_ddr3_emif_0_avl_0_translator_avalon_universal_slave_0_agent -L mm_bridge_10_m0_translator_avalon_universal_master_0_agent -L mem_if_ddr3_emif_0_avl_0_translator -L mm_bridge_10_m0_translator -L mm_interconnect_1 -L dll0 -L oct0 -L c0 -L dmaster -L s0 -L p0 -L pll0 -L rst_controller -L mm_interconnect_0 -L mm_bridge_0 -L mem_if_ddr3_emif_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
